...
STOCKS = [
     "MA", "MSFT", "GOOGL", "MLI", "SPGI", "PGR", "AXP", "DUOL", "PINS", "EXEL", "DECK", "AWI", "AAPL", "ABBV", "ABT", "ADBE", "ADP", "ADSK", "AMAT", "AMD", "AME", "AMT", "AMZN", "ANET", "APH", "APP", "APPF", "APD", "ASML", "ATEN", "AVGO", "AXON", "AZO", "BKNG", "BLK", "BMI", "BRO", "BR", "BRK-B", "BSX", "CARG", "CAT", "CB", "CDNS", "CELH", "CINF", "CHKP", "CME", "CMG", "CMI", "COF", "COST", "CPNG", "CPRT", "CPRX", "CRM", "CSGP", "CTAS", "DDOG", "DHR", "DLR", "DOCS", "DPZ", "DT", "DXCM", "EA", "ECL", "ELF", "EMR", "EPAM", "ETN", "EW", "EXLS", "EXR", "FAST", "FICO", "FSLR", "FTNT", "GATX", "GD", "GGG", "GDDY", "GS", "GWW", "HALO", "HD", "HEI", "HLT", "HOLX", "HON", "ICE", "IDXX", "IEX", "INTU", "IR", "ITW", "JNJ", "JPM", "KEYS", "KLAC", "LHX", "LIN", "LMAT", "LMT", "LOW", "LRCX", "LRN", "LULU", "MANH", "MAR", "MCD", "MCO", "MEDP", "MELI", "META", "MLM", "MPWR", "MS", "MSI", "MKTX", "NFLX", "NDAQ", "NOC", "NOW", "NSSC", "NVDA", "NVMI", "O", "ODD", "ON", "ONTO", "ORCL", "ORLY", "PANW", "PAYC", "PAYX", "PCTY", "PH", "PODD", "POOL", "PSA", "PTC", "PWR", "QFIN", "QLYS", "QCOM", "QSR", "REGN", "RMD", "ROL", "ROP", "ROK", "ROST", "RSG", "RTX", "SBAC", "SBUX", "SHOP", "SHW", "SNPS", "SAP", "SYK", "TDG", "TDY", "TMO", "TJX", "TRI", "TRMB", "TSLA", "TSM", "TT", "TXN", "TYL", "ULTA", "UNP", "USLM", "V", "VEEV", "VICI", "VMC", "VRSK", "VRSN", "WDAY", "WM", "WMT", "WPM", "WST", "WRB", "XYL", "ZTS", "A", "TXRH", "CROX", "PLTR", "WING", "IQV", "HUBS", "ESTC", "ICLR", "BILL", "FISV", "YUM", "ATKR", "MRVL", "BLDR", "CPAY", "TECH", "FROG", "DKS", "PMTS", "APO", "FDS", "SNA", "CBOE", "MORN", "RJF", "DORM", "IPAR", "TPL", "HLNE", "ISRG", "IDCC", "ERIE", "STRL", "INCY", "FIX", "TTD", "SN", "EME", "UHS", "IESC", "IRMD", "XPEL", "SFM", "CW", "FSS", "MSA", "NXT", "KNSL", "CVCO", "RLI", "FN", "AX", "ACGL", "GEV", "MSCI", "SKY", "MCK", "JKHY", "THG", "HCA", "HIG", "FINV", "LOPE", "TRV", "NBIX", "PSMT", "SKWD", "MWA", "VCTR", "HCI", "CHE", "MNST", "GSHD", "VRTX", "MAX", "BRC", "BRBR", "BOW", "ATAT", "TGLS", "FELE", "YELP", "MGIC"
]
