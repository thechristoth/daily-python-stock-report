...
# Configuration
STOCKS = [
     "MA","MSFT", "GOOGL", "MLI", "KO", "SPGI", "PGR", "AXP", "MNST", "DUOL", "PINS", "EXEL", "DECK", "SCHW", "AWI", "AAPL", "ABBV", "ABNB", "ABT", "ACAD", "ADBE", "ADP", "ADSK", "AMAT", "AMD", "AME", "AMT", "AMZN", "ANET", "APH", "APP", "APPF", "APD", "ASML", "ATEN", "AVGO", "AXON", "AZO", "BABA", "BMRN", "BKNG", "BLK", "BMI", "BRO", "BR", "BRK-B", "BSX", "CARG", "CAT", "CB", "CDNS", "CELH", "CINF", "CHD", "CHKP", "CHTR", "CMCSA", "CME", "CMG", "CMI", "COF", "COP", "COST", "CPNG", "CPRT", "CPRX", "CRM", "CSGP", "CTAS", "CTSH", "DAL", "DDOG", "DHR", "DIS", "DLR", "DOCS", "DPZ", "DT", "DXCM", "EA", "ECL", "ELF", "EMR", "ENB", "ENPH", "EPAM", "ETN", "EW", "EXLS", "EXR", "FAST", "FICO", "FIS", "FITB", "FSLR", "FTNT", "GATX", "GD", "GGG", "GDDY", "GILD", "GS", "GWW", "HALO", "HD", "HEI", "HLT", "HOLX", "HON", "ICE", "IDXX", "IEX", "ILMN", "INTU", "IR", "ISRG", "ITW", "JNJ", "JKHY", "JPM", "KEYS", "KLAC", "KMI", "LHX", "LIN", "LMAT", "LMT", "LOW", "LRCX", "LRN", "LULU", "MANH", "MAR", "MCD", "MCO", "MDT", "MEDP", "MELI", "META", "MKC", "MLM", "MPWR", "MS", "MSI", "MTB", "MKTX", "NFLX", "NDAQ", "NKE", "NOC", "NOW", "NSSC", "NVDA", "NVMI", "O", "ODD", "ON", "ONTO", "ORCL", "ORLY", "PANW", "PAYC", "PAYX", "PCTY", "PEP", "PH", "PODD", "POOL", "PSA", "PTC", "PWR", "PYPL", "QFIN", "QLYS", "QCOM", "QSR", "REGN", "RMD", "ROL", "ROP", "ROK", "ROST", "RSG", "RTX", "SBAC", "SBUX", "SE", "SHOP", "SHW", "SLB", "SMCI", "SNPS", "SAP", "SQ", "SYK", "TDG", "TDY", "TMO", "TJX", "TRI", "TRMB", "TSLA", "TSM", "TT", "TXN", "TYL", "UL", "ULTA", "UNP", "UPS", "USLM", "V", "VEEV", "VICI", "VMC", "VRSK", "VRSN", "WDAY", "WM", "WMT", "WPM", "WST", "WRB", "XOM", "XYL", "ZTS", 'ETSY', 'DOCU', 'A', 'TXRH', 'CROX', 'PLTR', 'WING', 'IQV', 'EXAS', 'HUBS', 'ESTC', 'ICLR', 'BILL', 'FISV', 'YUM', 'ATKR', 'MRVL', 'BLDR', 'CPAY', 'TECH', 'FROG', 'DKS', 'PMTS', 'APO', 'FDS', 'SNA', 'CBOE', 'MORN', 'RJF', 'DORM', 'IPAR', 'TPL', 'HLNE', 'ISRG', 'MPWR', 'IDCC', 'SSD', 'ANET', 'UTHR'
]
