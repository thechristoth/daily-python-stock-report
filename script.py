...
STOCKS = [
    ...
    "BRO", "BR", "BRK-B", "BSX", "CB", "CDNS", "CHKP", "CME", "CMG", "COF",
    "COST", "CPNG", "CPRT", "CPRX", "CRM", "CSGP", "CTAS", "DDOG", "DHR", "DOCS",
    "DT", "DXCM", "ECL", "EPAM", "ETN", "EW", "EXLS", "FAST", "FICO", "FTNT",
    "GGG", "GDDY", "GS", "GWW", "HALO", "HD", "HEI", "HLT", "HOLX", "HON",
    "ICE", "IDXX", "IEX", "INTU", "IR", "ITW", "JPM", "KEYS", "LIN", "LMAT",
    "LOW", "LRN", "LULU", "MANH", "MAR", "MCO", "MEDP", "MELI", "META", "MPWR",
    "MS", "MSI", "MKTX", "NFLX", "NDAQ", "NOW", "NVDA", "NVMI", "ONTO", "ORCL",
    "ORLY", "PANW", "PAYC", "PAYX", "PCTY", "PH", "PODD", "POOL", "PTC", "PWR",
    "QLYS", "QCOM", "REGN", "RMD", "ROL", "ROP", "ROK", "ROST", "SHOP", "SHW",
    ...
    "FISV", "ATKR", "MRVL", "CPAY", "TECH", "FROG", "DKS", "PMTS", "APO", "FDS",
