...
STOCKS = [
    "MA", "MSFT", "GOOGL", "MLI", "SPGI", "PGR", "AXP", "DUOL", "PINS", "DECK",
    "AAPL", "ABBV", "ADBE", "ADP", "ADSK", "AME", "AMZN", "ANET", "APH", "APP",
    "AVGO", "AXON", "AZO", "BKNG", "BLK", "BMI", "BRO", "BR", "BRK-B", "BSX",
    "CB", "CDNS", "CME", "CMG", "COF", "COST", "CPNG", "CPRT", "CPRX", "CRM",
    "CSGP", "CTAS", "DDOG", "DHR", "DT", "DXCM", "ECL", "ETN", "EW", "FAST",
    "FICO", "FTNT", "GGG", "GS", "GWW", "HALO", "HD", "HEI", "HLT",
    "HOLX", "HON", "ICE", "IDXX", "IEX", "INTU", "IR", "ITW", "JPM", "KEYS",
    "LIN", "LMAT", "LOW", "LULU", "MANH", "MAR", "MCO", "MEDP", "MELI", "META",
    "MPWR", "MS", "MSI", "MKTX", "NFLX", "NDAQ", "NOW", "NVDA", "NVMI", "ONTO",
    "ORCL", "ORLY", "PANW", "PAYC", "PAYX", "PCTY", "PH", "PODD", "POOL", "PTC",
    "PWR", "QLYS", "QCOM", "REGN", "RMD", "ROL", "ROP", "ROK", "ROST", "SHOP",
    "SHW", "SNPS", "SAP", "SYK", "TDG", "TDY", "TMO", "TRI", "TRMB", "TSM",
    "TT", "TXN", "TYL", "ULTA", "V", "VEEV", "VRSK", "VRSN", "WDAY", "WST",
    "WRB", "XYL", "ZTS", "A", "TXRH", "WING", "IQV", "HUBS", "FISV", "ATKR",
    "MRVL", "CPAY", "DKS", "APO", "FDS", "SNA", "CBOE", "RJF", "ISRG", "IDCC",
    "INCY", "FIX", "TTD", "SN", "CW", "NXT", "FN", "AX", "ACGL", "GEV",
