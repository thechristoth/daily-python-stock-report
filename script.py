...
STOCKS = [
    ...
    "ETN", "EW", "FAST", "FICO", "FTNT", "GGG", "GS", "GWW", "HD", "HEI",
    "HLT", "HOLX", "HON", "ICE", "IDXX", "IEX", "INTU", "IR", "ITW", "JPM",
    "KEYS", "LIN", "LMAT", "LOW", "MANH", "MAR", "MCO", "MEDP", "MELI", "META",
    "MPWR", "MS", "MSI", "MKTX", "NFLX", "NDAQ", "NOW", "NVDA", "NVMI", "ONTO",
    "ORCL", "ORLY", "PANW", "PAYC", "PAYX", "PH", "PODD", "PTC", "PWR", "QLYS",
    "QCOM", "REGN", "RMD", "ROP", "ROK", "ROST", "SHW", "SNPS", "SAP", "SYK",
    "TDG", "TDY", "TMO", "TRI", "TRMB", "TSM", "TT", "TXN", "TYL", "V",
    "VEEV", "VRSK", "VRSN", "WDAY", "WST", "WRB", "XYL", "ZTS", "A", "TXRH",
