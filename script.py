...
STOCKS = [
    "MA", "MSFT", "GOOGL", "SPGI", "PGR", "AXP", "DUOL", "PINS", "DECK", "AAPL",
    "ABBV", "ADBE", "ADP", "ADSK", "AME", "AMZN", "ANET", "APH", "APP", "AVGO",
    "AXON", "AZO", "BKNG", "BLK", "BMI", "BRO", "BR", "BRK-B", "BSX", "CB",
    "CDNS", "CME", "CMG", "COST", "CPRT", "CRM", "CSGP", "CTAS", "DHR", "DT",
    "DXCM", "ECL", "ETN", "EW", "FAST", "FICO", "FTNT", "GGG", "GS", "GWW",
    "HD", "HEI", "HLT", "HOLX", "HON", "ICE", "IDXX", "IEX", "INTU", "IR",
    "ITW", "JPM", "KEYS", "LIN", "LMAT", "LOW", "LULU", "MANH", "MAR", "MCO",
    "MEDP", "MELI", "META", "MPWR", "MS", "MSI", "MKTX", "NFLX", "NDAQ", "NOW",
    "NVDA", "NVMI", "ONTO", "ORCL", "ORLY", "PANW", "PAYC", "PAYX", "PH", "PODD",
    "POOL", "PTC", "PWR", "QLYS", "QCOM", "REGN", "RMD", "ROP", "ROK", "ROST",
    "SHOP", "SHW", "SNPS", "SAP", "SYK", "TDG", "TDY", "TMO", "TRI", "TRMB",
    "TSM", "TT", "TXN", "TYL", "ULTA", "V", "VEEV", "VRSK", "VRSN", "WDAY",
    "WST", "WRB", "XYL", "ZTS", "A", "TXRH", "IQV", "HUBS", "FISV", "ATKR",
    "MRVL", "APO", "FDS", "SNA", "CBOE", "ISRG", "IDCC", "FIX", "TTD", "SN",
    "ACGL", "GEV", "MSCI", "MCK", "HIG", "TRV", "MWA", "MNST", "VRTX", "UNH",
    "GEHC", "LLY", "WM", "WSO", "ASML", "VICI", "HSY", "DPZ", "HCA", "KLAC",
    "AMAT", "MKL", "KNSL", "YUM", "QSR", "RLI", "WCN", "AON", "EFX", "JKHY",
    "CHD", "RYAN", "MORN", "STE", "TSCO", "SSNC", "WAB", "ABT", "LRCX", "TJX",
