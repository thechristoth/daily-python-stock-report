...
<head>
    ...
    <title>Enhanced Stock Analysis Report with Sector-Specific Scoring</title>
    <style>
        body {{
...
<body>
    <div class="container">
        <h1>🚀 Enhanced Stock Analysis Dashboard with Sector-Specific Scoring</h1>
        ...
        <div class="info-grid">
            <div class="info-box">
                ...
                <p><strong>Sector-Specific Scoring:</strong> Each stock is evaluated based on sector-appropriate thresholds</p>
                <p><strong>Valuation:</strong> Sector-specific P/E, PEG, and other valuation metrics</p>
                <p><strong>Quality:</strong> Sector-appropriate ROE, ROIC, and margin expectations</p>
                <p><strong>Growth:</strong> Different growth expectations for different sectors</p>
            </div>
            
            <div class="info-box">
                <h3>🏢 Sector Categories</h3>
                <p><strong>Technology:</strong> High growth, high P/E tolerance</p>
                <p><strong>Utilities/Staples:</strong> Value/income focus, lower growth expectations</p>
                <p><strong>Financials:</strong> Special debt handling, quality emphasis</p>
                <p><strong>Energy:</strong> Cyclical adjustments, high FCF expectations</p>
                <p><strong>Healthcare/Industrials:</strong> Moderate growth expectations</p>
            </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>ROE<br><small>Profit M.</small></th>
                    <th>FCF/Share<br><small>FCF Yield</small></th>
                    <th>Sales<br><small style="color: rgba(255, 255, 255, 0.8);">5Y CAGR</small></th>
                    <th>EPS<br><small style="color: rgba(255, 255, 255, 0.8);">5Y CAGR</small></th>
                    <th>Recent Growth<br><small>TTM</small></th>
                    <th>Valuation<br>(0-10)</th>
                    <th>Stability<br>(0-10)</th>
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-top: 20px;">
            <h4>📝 How to Use This Sector-Specific Analysis</h4>
            <p><strong>Click any stock row</strong> to see detailed metrics including sector-specific analysis.</p>
            <p><strong>Sector Context:</strong> Each stock is evaluated using thresholds appropriate for its sector.</p>
            <p><strong>Score Interpretation:</strong> 7+ = Excellent | 5-7 = Good | Below 5 = Caution</p>
            <p><strong>Color Coding:</strong> 🟢 Green = Strong | 🟡 Yellow = Average | 🔴 Red = Weak</p>
        </div>
