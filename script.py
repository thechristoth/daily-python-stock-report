...
STOCKS = [
    ...
    "CB", "CDNS", "CME", "CMG", "COF", "COST", "CPRT", "CPRX", "CRM", "CSGP",
    "CTAS", "DDOG", "DHR", "DT", "DXCM", "ECL", "ETN", "EW", "FAST", "FICO",
    "FTNT", "GGG", "GS", "GWW", "HD", "HEI", "HLT", "HOLX", "HON", "ICE",
    "IDXX", "IEX", "INTU", "IR", "ITW", "JPM", "KEYS", "LIN", "LMAT", "LOW",
    "LULU", "MANH", "MAR", "MCO", "MEDP", "MELI", "META", "MPWR", "MS", "MSI",
    "MKTX", "NFLX", "NDAQ", "NOW", "NVDA", "NVMI", "ONTO", "ORCL", "ORLY", "PANW",
    "PAYC", "PAYX", "PCTY", "PH", "PODD", "POOL", "PTC", "PWR", "QLYS", "QCOM",
    "REGN", "RMD", "ROL", "ROP", "ROK", "ROST", "SHOP", "SHW", "SNPS", "SAP",
    "SYK", "TDG", "TDY", "TMO", "TRI", "TRMB", "TSM", "TT", "TXN", "TYL",
    "ULTA", "V", "VEEV", "VRSK", "VRSN", "WDAY", "WST", "WRB", "XYL", "ZTS",
